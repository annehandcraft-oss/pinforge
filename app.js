...
/* ==========================================================================
   PinForge v0.2.2 — Mobile Live Preview Patch
...
@media (max-width: 1023px) {
  ...
  /*
   * Normal pin stays exactly as designed.
   * It only becomes compact after JS adds
   * .pf-mobile-live-preview while scrolling.
   */
  #pinCard {
    transition:
  ...
  #pinCard.pf-mobile-live-preview {
    ...
    box-shadow:
      ...
      0 3px 10px rgba(17, 24, 39, 0.10) !important;

    overflow: hidden;

    animation: pfMiniPreviewIn 0.25s
      cubic-bezier(0.16, 1, 0.3, 1);
  }

  /*
   * Text inside mini preview must shrink too.
   * Otherwise headline stays huge.
   */
  #pinCard.pf-mobile-live-preview .pin-headline,
  #pinCard.pf-mobile-live-preview #pinHeadline {
    font-size: 9px !important;
    line-height: 1.1 !important;
  }

  #pinCard.pf-mobile-live-preview .pin-subheadline,
  #pinCard.pf-mobile-live-preview #pinSubheadline {
    font-size: 5px !important;
    line-height: 1.2 !important;
  }

  #pinCard.pf-mobile-live-preview #pinTextWrap {
    gap: 3px !important;
  }

  #pinCard.pf-mobile-live-preview #pinCtaWrap {
  ...
  #pinCard.pf-mobile-live-preview #pinCtaLabel {
    white-space: nowrap;
  }
}


@keyframes pfMiniPreviewIn {
...
/* Extra breathing room for very small iPhones */
